...
const LoginPage = () => {
  ...
  const handleCheckIC = () => {
    ...
    if (storedUser) {
      ...
      // Simple check: if IC matches (or just check if any user exists for demo)
      // For strict checking: if (user.icNumber === icInput)
      // For demo ease, we'll just check if the stored user matches the input roughly or just exist
