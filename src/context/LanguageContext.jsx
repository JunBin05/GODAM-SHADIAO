...
export const translations = {
  en: {
    ...
    newApplication: "Apply for STR Now",
    ...
    refresh: "Refresh",
    // New translations for SARA/STR pages
    notEligible: "Not Eligible",
    notEligibleSara: "You are currently not eligible for SARA aid.",
    nearbySaraMerchants: "Nearby SARA Merchants",
    notEligibleStoreMsg: "Even if you are not eligible, you can still visit these partner stores.",
    loadingStores: "Loading nearby stores...",
    noStoresFound: "No stores found nearby. Try again or check your location settings.",
    nearestBsnBranches: "Nearest BSN Branches",
  ...
  ms: {
    ...
    newApplication: "Mohon STR Sekarang",
    ...
    notEligibleSara: "Anda tidak layak untuk bantuan SARA pada masa ini.",
    nearbySaraMerchants: "Peniaga SARA Berdekatan",
    notEligibleStoreMsg: "Walaupun anda tidak layak, anda masih boleh melawat kedai rakan kongsi ini.",
    loadingStores: "Memuatkan kedai berdekatan...",
    noStoresFound: "Tiada kedai dijumpai berdekatan. Cuba lagi atau semak tetapan lokasi anda.",
    nearestBsnBranches: "Cawangan BSN Terdekat",
  ...
  'zh': {
    ...
    // New translations for SARA/STR pages
    notEligible: "不符合资格",
    notEligibleSara: "您目前不符合SARA援助的资格。",
    nearbySaraMerchants: "附近的SARA商家",
    notEligibleStoreMsg: "即使您不符合资格，您仍可以访问这些合作商店。",
    loadingStores: "正在加载附近商店...",
    noStoresFound: "附近未找到商店。请重试或检查您的位置设置。",
    nearestBsnBranches: "最近的BSN分行",
    howToRegister: "如何注册",
    navigate: "导航",
  ...
  'zh-tw': {
    ...
    // New translations for SARA/STR pages
    notEligible: "不符合資格",
    notEligibleSara: "您目前不符合SARA援助的資格。",
    nearbySaraMerchants: "附近的SARA商家",
    notEligibleStoreMsg: "即使您不符合資格，您仍可以訪問這些合作商店。",
    loadingStores: "正在載入附近商店...",
    noStoresFound: "附近未找到商店。請重試或檢查您的位置設置。",
    nearestBsnBranches: "最近的BSN分行",
    howToRegister: "如何註冊",
    navigate: "導航",
    viewAllOnMap: "在地圖上查看全部",
    sara: "SUMBANGAN ASAS RAHMAH (SARA)",
    enrolled: "已註冊",
    notEnrolled: "未註冊",
    nearbyStores: "附近的SARA商店",
  ...
  ta: {
    ...
    newApplication: "இப்போது STR க்கு விண்ணப்பிக்கவும்",
    ...
    notEligibleSara: "நீங்கள் தற்போது SARA உதவிக்கு தகுதியற்றவர்.",
    nearbySaraMerchants: "அருகிலுள்ள SARA வணிகர்கள்",
    notEligibleStoreMsg: "நீங்கள் தகுதியற்றவராக இருந்தாலும், இந்த கூட்டாளி கடைகளைப் பார்வையிடலாம்.",
    loadingStores: "அருகிலுள்ள கடைகளை ஏற்றுகிறது...",
    noStoresFound: "அருகில் கடைகள் கிடைக்கவில்லை. மீண்டும் முயற்சிக்கவும் அல்லது உங்கள் இருப்பிட அமைப்புகளை சரிபார்க்கவும்.",
    nearestBsnBranches: "அருகிலுள்ள BSN கிளைகள்",
    howToRegister: "பதிவு செய்வது எப்படி",
    navigate: "வழிசெலுத்து",
    viewAllOnMap: "வரைபடத்தில் அனைத்தையும் காண்க",
  }
};
